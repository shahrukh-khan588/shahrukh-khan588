...
function Register() {
    ...
    console.log(multiCordinates, 'multiCordinates');
        ...
        <Box m="12rem auto" maxWidth="30%">
            <Paper elevation={6} >
                <form onSubmit={formik.handleSubmit}
                    ...
                    <Box width='100%'>
                        {multiCordinates.length > 0 ? multiCordinates?.map((e) => {
                            return (
                                <Chip sx={{ margin: '5px', padding: '5px' }} label={e?.label} variant="outlined" onDelete={() => { handleDelete(e) }} />
                            )
                        }) : <></>}
                    </Box>
                    <TextField
